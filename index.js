...
console.log(createMenuItem('Green Curry', 15, 'lunch'));
...
console.log(createMenuItem("panini", 15, "dinner"));
...
*/
reviews.push({name:'Katharina' , price:5, feedback: 'loved it!'});
console.log(reviews);
